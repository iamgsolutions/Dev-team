...
For step 3 (PRD user flows in the browser), use the **E2E skill** (agent-browser:
snapshot → click by ref → assert, plus error-state mocking and Core Web Vitals).
It is injected into your pack — follow it to see and touch the UI like a user.
